...
chrome.extension.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.contentType === "create") {
    ...
    document.body.appendChild(bootstrapHTML);
    document.body.appendChild(mediumEditor);
    document.body.appendChild(mediumStyle); //wrap the body in a div to allow tooltip to work
...
//# sourceMappingURL=contentScript.bf0b630de19f7d58829e.hot-update.js.map