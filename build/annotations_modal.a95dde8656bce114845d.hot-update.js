webpackHotUpdate("annotations_modal",{
  ...
  function (_React$Component2) {
    ...
    _createClass(AnnotationEnvironment, [{
      ...
      value: function componentDidMount() {
        ...
        var annotationObjects = new annotationMap(); //get all the annotations
      ...
      value: function deleteAnnotation(element) {
        var newAnnotationMap = new annotationMap(this.state.annotationObjects).deleteAnnotation(this.selected.props.channels, this.selected.props.quote);
        ; // this.updateState({
        // 	operation: "delete",
        // 	annotationObjects:
        // 			// });
      ...
      value: function newAnnotation() {
        ...
        var newAnnotationMap = new annotationMap(this.state.annotationObjects).add(newAnnotation.channels, newAnnotation);
        this.selected = {
          props: newAnnotation
        };
      ...
      value: function submitAnnotationEdit() {
        ...
        //;
        var newAnnotationMap = new annotationMap(this.state.annotationObjects).editAnnotation(this.selected.props.channels, this.selected.props.quote, this.annotation.value);
        this.updateState({
          annotationObjects: newAnnotationMap
        });
        this.newAnnotationChannels = newAnnotationMap.keysAsArray();
...
//# sourceMappingURL=annotations_modal.a95dde8656bce114845d.hot-update.js.map