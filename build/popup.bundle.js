...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "0ef64d2a8891e6f0066d";
...
/******/ 	return hotCreateRequire("./src/popup.js")(__webpack_require__.s = "./src/popup.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  return {
    createContextMenus: function createContextMenus() {
      var annotationText;
     ...
     *   is found
     */
    getCurrentTabUrl: function getCurrentTabUrl() {
     ...
     */
    performAnnotate: function performAnnotate() {
      // //update the extension text
     ...
     */
    getSavedAnnotations: function getSavedAnnotations(url) {
    ...
    // //
    // // },
    save: function save(quoteText, annotationText, channels) {
      if (!quoteText || !annotationText) return; //don't do anything if annotation invalid
      // chrome.storage.sync.get(url, items=>{
      ...
      var storageItem = _defineProperty({}, quoteText, {
    ...
    getAnnotationObjModel: function getAnnotationObjModel(url, quoteText, annotationText) {
      //	let items = {};
      //	items[url] = {};
      //	items[url][quoteText] = {};
      //	items[url][quoteText].annotation = annotationText;
    ...
    setQuoteObj: function setQuoteObj() {},
    //get all quotes that are associated with the given url
    loadQuotes: function loadQuotes(url) {
      chrome.storage.sync.get(null, function (quotes) {
        var theQuotes = quotes.filter(function (quote) {
    ...
    saveQuote: function saveQuote(url, quote, annotation, channels) {
    ...
    saveChannels: function saveChannels(channels) {
      //make new key/value pair for data
      var quoteObj = {};
      quoteObj['channels'] = {
        channels: channels
    ...
    saveQuoteStateModel: function saveQuoteStateModel(url, quote, annotation) {
      //make new key/value pair for data
      var quoteObj = {};
      quoteObj[quote] = {
        url: url,
    ...
    // user devices.
    preSaveAnnotation: function preSaveAnnotation() {
    ...
    findAnnotation: function findAnnotation(quoteText) {
...
/* harmony default export */ __webpack_exports__["default"] = (function (request) {
  ...
  /*#__PURE__*/
  function (_React$Component) {
    _inherits(AnnotationModal, _React$Component);

    function AnnotationModal(props) {
      var _this;

      _classCallCheck(this, AnnotationModal);

      _this = _possibleConstructorReturn(this, _getPrototypeOf(AnnotationModal).call(this));
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  getCurrentTabUrl(function (url) {
    var dropdown = document.getElementById('dropdown'); // Load the saved annotations for this page and modify the dropdown
    // value, if needed.

    quoteText.then(function (response) {
      getSavedAnnotations(url, function (savedAnnotationObjects) {
        if (savedAnnotationObjects) {
          console.log(savedAnnotationObjects); //let annotationText = performAnnotate();
