...
chrome.extension.onMessage.addListener(function (request, sender, sendResponse) {
  if (request.contentType === "create") {
    ...
    mediumEditor.onload = function () {
      ...
      editorScript.innerHTML = "var editor = new MediumEditor('.mediumeditable');";
    ...
    editableWrap.className = 'mediumeditable'; // Move the body's children into this wrapper

    while (document.body.firstChild) {
      editableWrap.appendChild(document.body.firstChild);
    }

    document.body.contentEditable = false; // Append the wrapper to the body
...
//# sourceMappingURL=contentScript.71473835d371897c5333.hot-update.js.map